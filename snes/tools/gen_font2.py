#!/usr/bin/env python3
"""
gen_font2.py — Generate SNES 2bpp anti-aliased 16×16 font tiles for Mode 5.

Outputs:
  ../assets/font2.inc          — tile data (SNES 2bpp, dense-packed for Mode 5)
...
def main() -> None:
    ...
    print(f"font2.inc: {total_slots} 8x8 tiles "
