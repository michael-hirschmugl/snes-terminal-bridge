...
- **`gen_font.py` erzeugt vier Artefakte**:
  - `font.inc` — 4bpp-Tiles, **aktiv verwendet** (BG1 in Mode 1, per `.include` in `main.asm`).
  - `font2.inc` — 2bpp-Tiles, **derzeit ungenutzt**. Vorbereitung für einen möglichen Hi-Res-Mode-5-Umbau (BG2 für ungerade Pixelspalten). Wird generiert, aber vom Linker nicht angezogen.
