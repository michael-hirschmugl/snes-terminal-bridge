...
├── src/
│   └── main.asm          # SNES 65816 assembly — scrolling multi-row terminal
├── assets/               # Generated files (not committed)
│   ├── font.inc          # SNES 4bpp tile data (generated by gen_font.py)
│   ├── tilemap.inc       # BG1 tilemap entries — 64×64, all blank (generated by gen_font.py)
│   └── keymap.inc        # Button bitmask → tile number table (generated by gen_keymap.py)
└── tools/
    ├── gen_font.py        # Renders TTF font → SNES 4bpp tiles + blank tilemap
...
- **Font generation:** `tools/gen_font.py` uses Pillow to render a monospace TTF (size 13) into 8×16 cells, splits into top/bottom 8×8 halves, converts to SNES 4bpp format
